...
//void display_number(uint8_t digit)
//{
//	uint8_t digit1=digit/10;
//	uint8_t digit2=digit%10;
//
//	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_1, GPIO_PIN_RESET);
//	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_RESET);
////	HAL_Delay(1);
//
//	show_numbers(1,digit1);
//	HAL_Delay(1);
//
//	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_1, GPIO_PIN_RESET);
//	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_RESET);
////	HAL_Delay(1);
//
//	show_numbers(2,digit2);
//	HAL_Delay(10);
//}
//void show_numbers(int dizit, uint8_t number)
//{
//	if(number>9)
//	{
//		return;
...
//        HAL_GPIO_WritePin(GPIOB,
//                GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_7 | GPIO_PIN_9
...
//                GPIO_PIN_SET);
//        HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_10,
//                GPIO_PIN_RESET);
//        break;
//    case 3:
//        HAL_GPIO_WritePin(GPIOB,
...
//                GPIO_PIN_SET);
//        HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3 | GPIO_PIN_8 | GPIO_PIN_10,
//                GPIO_PIN_RESET);
//        break;
//    case 4:
//        HAL_GPIO_WritePin(GPIOB,
...
//                GPIO_PIN_SET);
//        HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3 | GPIO_PIN_7 | GPIO_PIN_10,
//                GPIO_PIN_RESET);
//        break;
//    case 6:
//        HAL_GPIO_WritePin(GPIOB,
